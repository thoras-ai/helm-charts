...
![Version: 4.126.10](https://img.shields.io/badge/Version-4.126.10-informational?style=flat-square) ![AppVersion: 4.104.8](https://img.shields.io/badge/AppVersion-4.104.8-informational?style=flat-square)
...
| ---------------------------------- | ------- | ------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------- |
| thorasVersion                      | String  | 4.104.8                                          | Thoras app version                                                                                                   |
