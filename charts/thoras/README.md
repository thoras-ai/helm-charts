...
![Version: 4.55.1](https://img.shields.io/badge/Version-4.55.1-informational?style=flat-square) ![AppVersion: 4.42.1](https://img.shields.io/badge/AppVersion-4.42.1-informational?style=flat-square)
...
| ------------------------- | ------- | ------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------- |
| thorasVersion             | String  | 4.42.1                                           | Thoras app version                                                                                                   |
