...
![Version: 4.97.1](https://img.shields.io/badge/Version-4.97.1-informational?style=flat-square) ![AppVersion: 4.78.2](https://img.shields.io/badge/AppVersion-4.78.2-informational?style=flat-square)
...
| ---------------------------------- | ------- | ------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------- |
| thorasVersion                      | String  | 4.78.2                                           | Thoras app version                                                                                                   |
