...
![Version: 4.61.2](https://img.shields.io/badge/Version-4.61.2-informational?style=flat-square) ![AppVersion: 4.47.2](https://img.shields.io/badge/AppVersion-4.47.2-informational?style=flat-square)
...
| ------------------------- | ------- | ------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------- |
| thorasVersion             | String  | 4.47.2                                           | Thoras app version                                                                                                   |
