...
![Version: 4.70.0](https://img.shields.io/badge/Version-4.70.0-informational?style=flat-square) ![AppVersion: 4.57.0](https://img.shields.io/badge/AppVersion-4.57.0-informational?style=flat-square)
...
| ---------------------------------- | ------- | ------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------- |
| thorasVersion                      | String  | 4.57.0                                           | Thoras app version                                                                                                   |
