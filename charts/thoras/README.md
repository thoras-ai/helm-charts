...
![Version: 4.61.1](https://img.shields.io/badge/Version-4.61.1-informational?style=flat-square) ![AppVersion: 4.47.1](https://img.shields.io/badge/AppVersion-4.47.1-informational?style=flat-square)
...
| ------------------------- | ------- | ------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------- |
| thorasVersion             | String  | 4.47.1                                           | Thoras app version                                                                                                   |
