...
![Version: 4.126.9](https://img.shields.io/badge/Version-4.126.9-informational?style=flat-square) ![AppVersion: 4.104.7](https://img.shields.io/badge/AppVersion-4.104.7-informational?style=flat-square)
...
| ---------------------------------- | ------- | ------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------- |
| thorasVersion                      | String  | 4.104.7                                          | Thoras app version                                                                                                   |
