...
![Version: 4.27.0](https://img.shields.io/badge/Version-4.27.0-informational?style=flat-square) ![AppVersion: 4.13.0](https://img.shields.io/badge/AppVersion-4.13.0-informational?style=flat-square)
...
| ------------------------- | ------- | ------------------------------------------------ | ------------------------------------------------------------------ |
| thorasVersion             | String  | 4.13.0                                           | Thoras app version                                                 |
