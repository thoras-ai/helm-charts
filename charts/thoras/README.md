...
![Version: 4.136.2](https://img.shields.io/badge/Version-4.136.2-informational?style=flat-square) ![AppVersion: 4.112.1](https://img.shields.io/badge/AppVersion-4.112.1-informational?style=flat-square)
...
| ---------------------------------- | ------- | ------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------- |
| thorasVersion                      | String  | 4.112.1                                          | Thoras app version                                                                                                   |
