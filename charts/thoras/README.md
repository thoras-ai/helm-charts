...
![Version: 4.54.1](https://img.shields.io/badge/Version-4.54.1-informational?style=flat-square) ![AppVersion: 4.41.2](https://img.shields.io/badge/AppVersion-4.41.2-informational?style=flat-square)
...
| ------------------------- | ------- | ------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------- |
| thorasVersion             | String  | 4.41.2                                           | Thoras app version                                                                                                   |
