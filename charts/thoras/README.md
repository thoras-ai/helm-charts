...
![Version: 4.33.0](https://img.shields.io/badge/Version-4.33.0-informational?style=flat-square) ![AppVersion: 4.18.0](https://img.shields.io/badge/AppVersion-4.18.0-informational?style=flat-square)
...
| ------------------------- | ------- | ------------------------------------------------ | ------------------------------------------------------------------ |
| thorasVersion             | String  | 4.18.0                                           | Thoras app version                                                 |
