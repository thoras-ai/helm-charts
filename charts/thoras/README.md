...
![Version: 4.126.5](https://img.shields.io/badge/Version-4.126.5-informational?style=flat-square) ![AppVersion: 4.104.3](https://img.shields.io/badge/AppVersion-4.104.3-informational?style=flat-square)
...
| ---------------------------------- | ------- | ------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------- |
| thorasVersion                      | String  | 4.104.3                                          | Thoras app version                                                                                                   |
