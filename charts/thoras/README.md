...
![Version: 4.64.0](https://img.shields.io/badge/Version-4.64.0-informational?style=flat-square) ![AppVersion: 4.50.0](https://img.shields.io/badge/AppVersion-4.50.0-informational?style=flat-square)
...
| ------------------------- | ------- | ------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------- |
| thorasVersion             | String  | 4.50.0                                           | Thoras app version                                                                                                   |
