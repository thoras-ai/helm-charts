...
![Version: 4.28.0](https://img.shields.io/badge/Version-4.28.0-informational?style=flat-square) ![AppVersion: 4.14.0](https://img.shields.io/badge/AppVersion-4.14.0-informational?style=flat-square)
...
| ------------------------- | ------- | ------------------------------------------------ | ------------------------------------------------------------------ |
| thorasVersion             | String  | 4.14.0                                           | Thoras app version                                                 |
