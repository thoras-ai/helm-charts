...
![Version: 4.59.2](https://img.shields.io/badge/Version-4.59.2-informational?style=flat-square) ![AppVersion: 4.45.4](https://img.shields.io/badge/AppVersion-4.45.4-informational?style=flat-square)
...
| ------------------------- | ------- | ------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------- |
| thorasVersion             | String  | 4.45.4                                           | Thoras app version                                                                                                   |
