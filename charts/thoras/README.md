...
![Version: 4.126.8](https://img.shields.io/badge/Version-4.126.8-informational?style=flat-square) ![AppVersion: 4.104.6](https://img.shields.io/badge/AppVersion-4.104.6-informational?style=flat-square)
...
| ---------------------------------- | ------- | ------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------- |
| thorasVersion                      | String  | 4.104.6                                          | Thoras app version                                                                                                   |
