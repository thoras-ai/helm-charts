...
![Version: 4.132.0](https://img.shields.io/badge/Version-4.132.0-informational?style=flat-square) ![AppVersion: 4.108.0](https://img.shields.io/badge/AppVersion-4.108.0-informational?style=flat-square)
...
| ---------------------------------- | ------- | ------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------- |
| thorasVersion                      | String  | 4.108.0                                          | Thoras app version                                                                                                   |
