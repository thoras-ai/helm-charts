...
![Version: 4.64.4](https://img.shields.io/badge/Version-4.64.5-informational?style=flat-square) ![AppVersion: 4.50.5](https://img.shields.io/badge/AppVersion-4.50.3-informational?style=flat-square)
...
| ---------------------------------- | ------- | ------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------- |
| thorasVersion                      | String  | 4.50.3                                           | Thoras app version                                                                                                   |
