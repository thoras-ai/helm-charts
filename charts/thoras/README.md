...
![Version: 4.63.0](https://img.shields.io/badge/Version-4.63.0-informational?style=flat-square) ![AppVersion: 4.49.0](https://img.shields.io/badge/AppVersion-4.49.0-informational?style=flat-square)
...
| ------------------------- | ------- | ------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------- |
| thorasVersion             | String  | 4.49.0                                           | Thoras app version                                                                                                   |
...
| thorasWorker.enableDirectForecastQueueing   | Boolean | false         | Enable direct queueing of forecasts                          |
