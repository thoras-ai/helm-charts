...
![Version: 4.43.1](https://img.shields.io/badge/Version-4.43.1-informational?style=flat-square) ![AppVersion: 4.30.0](https://img.shields.io/badge/AppVersion-4.30.0-informational?style=flat-square)
...
| ------------------------- | ------- | ------------------------------------------------ | ------------------------------------------------------------------ |
| thorasVersion             | String  | 4.30.0                                           | Thoras app version                                                 |
