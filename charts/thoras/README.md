...
![Version: 4.40.0](https://img.shields.io/badge/Version-4.40.0-informational?style=flat-square) ![AppVersion: 4.26.0](https://img.shields.io/badge/AppVersion-4.26.0-informational?style=flat-square)
...
| ------------------------- | ------- | ------------------------------------------------ | ------------------------------------------------------------------ |
| thorasVersion             | String  | 4.26.0                                           | Thoras app version                                                 |
