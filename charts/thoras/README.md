...
![Version: 4.71.0](https://img.shields.io/badge/Version-4.71.0-informational?style=flat-square) ![AppVersion: 4.58.0](https://img.shields.io/badge/AppVersion-4.58.0-informational?style=flat-square)
...
| ---------------------------------- | ------- | ------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------- |
| thorasVersion                      | String  | 4.58.0                                           | Thoras app version                                                                                                   |
