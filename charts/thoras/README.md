...
![Version: 4.61.3](https://img.shields.io/badge/Version-4.61.3-informational?style=flat-square) ![AppVersion: 4.47.4](https://img.shields.io/badge/AppVersion-4.47.4-informational?style=flat-square)
...
| ------------------------- | ------- | ------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------- |
| thorasVersion             | String  | 4.47.4                                           | Thoras app version                                                                                                   |
