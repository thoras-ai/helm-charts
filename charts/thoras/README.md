...
![Version: 4.55.4](https://img.shields.io/badge/Version-4.55.4-informational?style=flat-square) ![AppVersion: 4.42.3](https://img.shields.io/badge/AppVersion-4.42.3-informational?style=flat-square)
...
| ------------------------- | ------- | ------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------- |
| thorasVersion             | String  | 4.42.3                                           | Thoras app version                                                                                                   |
