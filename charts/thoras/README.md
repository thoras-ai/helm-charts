...
![Version: 4.104.0](https://img.shields.io/badge/Version-4.104.0-informational?style=flat-square) ![AppVersion: 4.83.1](https://img.shields.io/badge/AppVersion-4.83.1-informational?style=flat-square)
...
| ---------------------------------- | ------- | ------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------- |
| thorasVersion                      | String  | 4.83.1                                           | Thoras app version                                                                                                   |
