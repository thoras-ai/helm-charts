...
![Version: 4.39.0](https://img.shields.io/badge/Version-4.39.0-informational?style=flat-square) ![AppVersion: 4.25.0](https://img.shields.io/badge/AppVersion-4.25.0-informational?style=flat-square)
...
| ------------------------- | ------- | ------------------------------------------------ | ------------------------------------------------------------------ |
| thorasVersion             | String  | 4.25.0                                           | Thoras app version                                                 |
