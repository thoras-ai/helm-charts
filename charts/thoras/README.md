...
![Version: 4.59.1](https://img.shields.io/badge/Version-4.59.1-informational?style=flat-square) ![AppVersion: 4.45.2](https://img.shields.io/badge/AppVersion-4.45.2-informational?style=flat-square)
...
| ------------------------- | ------- | ------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------- |
| thorasVersion             | String  | 4.45.2                                           | Thoras app version                                                                                                   |
